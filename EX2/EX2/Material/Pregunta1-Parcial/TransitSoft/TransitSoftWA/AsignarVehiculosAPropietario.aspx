            ...
            <div class="container">
                <div class="card">
                        ...
                        <div class="card border">
                            ...
                            <div class="card-body">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:LinkButton ID="lbAgregarVehiculo" runat="server" Text="<i class='fa-solid fa-plus pe-2'></i> Agregar Vehiculo" CssClass="btn btn-success" OnClick="lbAgregarVehiculo_Click"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <asp:GridView ID="gvVehiculos" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lbBorrarLOV" runat="server" Text="<i class='fa-solid fa-trash'></i>" CommandArgument='<%# Eval("Placa") %>' OnClick="lbBorrarLOV_Click" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                    ...
                    <div class="card-footer clearfix">
                        ...
                        <asp:LinkButton ID="lbGuardar" runat="server" Text="<i class='fa-solid fa-floppy-disk pe-2'></i> Guardar" CssClass="float-end btn btn-primary"  OnClick ="lbGuardar_Click"/>
                    </div>
                </div>
            </div>
        </ContentTemplate>
