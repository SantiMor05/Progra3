...
{
    /// <summary>
    /// Test rápido y simple para verificar ambas conexiones
    /// </summary>
    class TestSimpleConnection
    {
        ...
        {
            Console.WriteLine("╔════════════════════════════════════════════════╗");
            Console.WriteLine("║   TEST RÁPIDO DE CONEXIÓN A DOS BDs          ║");
            Console.WriteLine("╚════════════════════════════════════════════════╝\n");
            ...
            ProbarConexion2();
            Console.WriteLine();
            ProbarConexionesSimultaneas();

            Console.WriteLine("\n\nPresione cualquier tecla para salir...");
            Console.ReadKey();
        }

        static void ProbarConexion1()
        {
        ...
        static void ProbarConexionesSimultaneas()
        {
            ...
            try
            {
                ...
                //cmd2.CommandText = "SELECT 'BD2' as Origen, NOW() as Tiempo"; // MySQL
                cmd2.CommandText = "SELECT 'BD2' as Origen, GETDATE() as Tiempo";
